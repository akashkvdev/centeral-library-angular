...
export class AllDataService {
  ...
  apiUrl='http://45.114.48.134:8090/api';
...
RequestedBookIssue(data:any){
  ...
  getBookAccessionNoRange(accession_no_from: any, accession_no_to: any) {
    
    return this.http.get(`${this.apiUrl}/book_dtls_in_accs_no_range/${accession_no_from}/${accession_no_to}`);
  }
